	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<form:form action="countryConfig" method="post" commandName="countryModel"
					name="countryConfig" id="countryConfig" cssClass="card">
					
					<div class="card-header">
						<h3 class="card-title"><i class="fe fe-user-plus"></i> &nbsp;&nbsp;Country Configuration </h3>
						...
						<div class="row">
							...
							<div class="col-md-6 col-lg-6">
								<div class="form-group">
									<label class="form-label">Country Name <b>*</b></label>
									<form:input path="strCountryName" id="strCountryName"
										cssClass="form-control" />
									<span class="error" id="strCountryNameError"><form:errors
											path="strCountryName"></form:errors></span>
								</div>
							</div>
					...
					<div class="card-body">
					<table id="countryTable" class="table table-striped table-bordered nowrap" style="width:100%">
					<thead>
						<tr>
							<th>Select</th>
							<th>Country Name</th>
					...
					<tbody>
						<c:forEach var="itr" items="${countryList}">
							<tr>
								<td>
