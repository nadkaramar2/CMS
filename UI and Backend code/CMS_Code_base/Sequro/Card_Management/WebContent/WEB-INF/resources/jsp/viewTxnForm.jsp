		...
		<div class="row">
			<div class="col-lg-12">
				<form:form action="addPinPrinting" method="post"
					commandName="transactionRequest" name="viewTxnForm"
					id="viewTxnForm" cssClass="card">

					<div class="card-header">
						<h3 class="card-title">View Transaction</h3>
					...
					<div class="card-body" style="width: 100%;" align="left">
							...
							<div class="col-md-6 col-lg-6">
								<div class="form-group">
									...
									<div class='input-group date' id='datetimepicker1'>
										<form:input path="formDate" id="formDate"
											cssClass="form-control" readonly="true" />
										<span class="input-group-addon input-group-append"
											id="basic-addon2"> <span class="input-group-text"><i
						...
						<div class="card-footer text-right">
							<div class=".d-flex1">
								<button type="submit" id="genEmboss"
									class="btn btn-primary ml-auto">Execute Pin Mailer
									Printing</button>
							</div>
						</div>
