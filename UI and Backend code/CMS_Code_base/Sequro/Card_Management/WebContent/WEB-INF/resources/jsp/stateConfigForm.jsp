	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<form:form action="stateConfig" method="post" commandName="stateModel"
					name="stateConfig" id="stateConfig" cssClass="card">
					
					<div class="card-header">
						<h3 class="card-title"><i class="fe fe-user-plus"></i> &nbsp;&nbsp;State Configuration </h3>
					...
					<div class="card-body">
						...
						<div class="form-group">
									...
									<form:select path="strCountryID" id="strCountryID"
							...
							<div class="col-md-6 col-lg-6">
								<div class="form-group">
									<label class="form-label">State Name <b>*</b></label>
									<form:input path="strStateName" id="strStateName"
										cssClass="form-control" />
									<span class="error" id="strStateNameError"><form:errors
											path="strStateName"></form:errors></span>
								</div>
							</div>
					...
					<div class="card-body">
					<table id="stateTable" class="table table-hover table-outline table-vcenter text-nowrap card-table" style="width:100%">
					<thead>
						<tr>
					...
					<tbody>
						<c:forEach var="itr" items="${stateList}">
							<tr>
								<td>
                            ...
                            <div class="custom-control-label"></div>
								...
								<td>${itr.strCountryID}</td>
								<td>${itr.strStateName}</td>
								<td>${itr.strStatus}</td>
								<td>
