...
var tbl;
var cardInventoryPendingDataJson;
	...
	$(document).ready(function() {
		...
		.click(
				function() {
					...
					var _url = "${pageContext.request.contextPath}/cms-reports/downloadCardInventoryPendingReport/";
					
					console.log(cardInventoryPendingDataJson);
					try {
						$.ajax({
							type : "POST",
							contentType : "application/json",
							url : _url,
							data : JSON.stringify(cardInventoryPendingDataJson),
							dataType : 'json',
							contentType : "application/json",
							timeout : 100000,
...
$('#excelButton')
		.click(
				function() 
				{
					...
					var _url = "${pageContext.request.contextPath}/cms-reports/downloadExcelCardInventoryPendingReport/";
					console.log(cardInventoryPendingDataJson);
					try {
						$.ajax({
							type : "POST",
		...
		if (compareDate(fromDate, toDate)) {
			...
			$
					.ajax({
						type : "POST",
						contentType : "application/json",
						url : "${pageContext.request.contextPath}/getCardInventoryPending/"
								+ fromDate + "/" + toDate,
						dataType : 'json',
						timeout : 100000,
						success : function(data) 
						{
							cardInventoryPendingDataJson = data;	
...
<div class="my-3 my-md-5">
	...
	<div id="download_spinner" style="display:none;">
		...
		<div class="row">
			<div class="col-lg-12">
				<form:form action="cardInventoryPending" method="get"
					commandName="cardInventoryPending" name="cardInventoryPending"
					id="cardInventoryPending" enctype="multipart/form-data"
					cssClass="card" onSubmit="return false">
					<div class="card-header">
						<h3 class="card-title">Card Inventory Pending Report</h3>
