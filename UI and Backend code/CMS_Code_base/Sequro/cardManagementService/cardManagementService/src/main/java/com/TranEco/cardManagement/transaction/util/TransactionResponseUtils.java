...
@Component
public class TransactionResponseUtils {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		TransactionResponseUtils.data = hexStr.substring(64);
		TransactionResponseUtils utils = new TransactionResponseUtils();
		...
		System.out.println(TransactionResponseUtils.data);
		...
		for(String data: utils.tagList) {
			...
			if(tlv != null) {
				String value = parseTag(tlv.getType(), TransactionResponseUtils.data);
