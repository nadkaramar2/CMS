...
public class AppConfig {
	...
	public EmbossFile getEmbossFile() 
	{
		...
		// try (BufferedReader br = new BufferedReader(new FileReader("C:\\CMS\\winservice\\cms\\cms\\emboss.xml")))
		try (BufferedReader br = new BufferedReader(new FileReader("C:\\CMS\\winservice\\cardManagement\\cms\\emboss.xml")))
